...
//246193/261166/2.50/20/0/Connector
...
(library Library_1
	...
	(patternDef "SHDR20W99P254_2X10_3302X889X94" (originalName "SHDR20W99P254_2X10_3302X889X94")
		(multiLayer
			(pad (padNum 1) (padStyleRef s240_h160) (pt 0, 0) (rotation 90))
			(pad (padNum 2) (padStyleRef c240_h160) (pt 0, 2.54) (rotation 90))
			(pad (padNum 3) (padStyleRef c240_h160) (pt 2.54, 0) (rotation 90))
			(pad (padNum 4) (padStyleRef c240_h160) (pt 2.54, 2.54) (rotation 90))
			(pad (padNum 5) (padStyleRef c240_h160) (pt 5.08, 0) (rotation 90))
			(pad (padNum 6) (padStyleRef c240_h160) (pt 5.08, 2.54) (rotation 90))
			(pad (padNum 7) (padStyleRef c240_h160) (pt 7.62, 0) (rotation 90))
			(pad (padNum 8) (padStyleRef c240_h160) (pt 7.62, 2.54) (rotation 90))
			(pad (padNum 9) (padStyleRef c240_h160) (pt 10.16, 0) (rotation 90))
			(pad (padNum 10) (padStyleRef c240_h160) (pt 10.16, 2.54) (rotation 90))
			(pad (padNum 11) (padStyleRef c240_h160) (pt 12.7, 0) (rotation 90))
			(pad (padNum 12) (padStyleRef c240_h160) (pt 12.7, 2.54) (rotation 90))
			(pad (padNum 13) (padStyleRef c240_h160) (pt 15.24, 0) (rotation 90))
			(pad (padNum 14) (padStyleRef c240_h160) (pt 15.24, 2.54) (rotation 90))
			(pad (padNum 15) (padStyleRef c240_h160) (pt 17.78, 0) (rotation 90))
			(pad (padNum 16) (padStyleRef c240_h160) (pt 17.78, 2.54) (rotation 90))
			(pad (padNum 17) (padStyleRef c240_h160) (pt 20.32, 0) (rotation 90))
			(pad (padNum 18) (padStyleRef c240_h160) (pt 20.32, 2.54) (rotation 90))
			(pad (padNum 19) (padStyleRef c240_h160) (pt 22.86, 0) (rotation 90))
			(pad (padNum 20) (padStyleRef c240_h160) (pt 22.86, 2.54) (rotation 90))
		)
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0, 0) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -5.33 -3.425) (pt -5.33 6.165) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -5.33 6.165) (pt 28.39 6.165) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 28.39 6.165) (pt 28.39 -3.425) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 28.39 -3.425) (pt -5.33 -3.425) (width 0.05))
		)
		(layerContents (layerNumRef 28)
			(line (pt -5.08 -3.175) (pt -5.08 5.915) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -5.08 5.915) (pt 28.14 5.915) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 28.14 5.915) (pt 28.14 -3.175) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 28.14 -3.175) (pt -5.08 -3.175) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt 0 -3.175) (pt 28.14 -3.175) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 28.14 -3.175) (pt 28.14 5.915) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 28.14 5.915) (pt -5.08 5.915) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -5.08 5.915) (pt -5.08 0) (width 0.2))
		)
	)
	(symbolDef "70246-2001" (originalName "70246-2001")
	...
	(compDef "70246-2001" (originalName "70246-2001") (compHeader (numPins 20) (numParts 1) (refDesPrefix J)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "70246-2001"))
		(attachedPattern (patternNum 1) (patternName "SHDR20W99P254_2X10_3302X889X94")
			(numPads 20)
			(padPinMap
		...
		(attr "Manufacturer_Part_Number" "70246-2001")
		(attr "Mouser Part Number" "538-70246-2001")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Molex/70246-2001?qs=L7RdmAxh%252BcMgmUPcB5dMoQ%3D%3D")
		(attr "Arrow Part Number" "")
		(attr "Arrow Price/Stock" "")
		(attr "Description" "Headers & Wire Housings 20CKT SHRD HDR")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/2/70246-2001.pdf")
		(attr "<Component Height>" "9.47")
		(attr "<STEP Filename>" "70246-2001.stp")
		(attr "<STEP Offsets>" "X=11.53;Y=1.27;Z=5.6")

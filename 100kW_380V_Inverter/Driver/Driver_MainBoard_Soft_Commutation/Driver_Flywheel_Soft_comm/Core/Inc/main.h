...
# define DR_1_ON   HAL_GPIO_WritePin(GPIOC, GPIO_PIN_3, GPIO_PIN_SET)
# define DR_1_OFF  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_3, GPIO_PIN_RESET)

# define DR_2_ON   HAL_GPIO_WritePin(GPIOC, GPIO_PIN_7, GPIO_PIN_SET)
# define DR_2_OFF  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_7, GPIO_PIN_RESET)

# define DR_3_ON   HAL_GPIO_WritePin(GPIOC, GPIO_PIN_8, GPIO_PIN_SET)
# define DR_3_OFF  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_8, GPIO_PIN_RESET)

# define DR_4_ON   HAL_GPIO_WritePin(GPIOC, GPIO_PIN_9, GPIO_PIN_SET)
# define DR_4_OFF  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_9, GPIO_PIN_RESET)

# define DR_5_ON   HAL_GPIO_WritePin(GPIOB, GPIO_PIN_2, GPIO_PIN_SET)
# define DR_5_OFF  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_2, GPIO_PIN_RESET)

# define DR_6_ON   HAL_GPIO_WritePin(GPIOC, GPIO_PIN_1, GPIO_PIN_SET)
# define DR_6_OFF  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_1, GPIO_PIN_RESET)

# define DR_7_ON   HAL_GPIO_WritePin(GPIOC, GPIO_PIN_2, GPIO_PIN_SET)
# define DR_7_OFF  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_2, GPIO_PIN_RESET)

# define DR_8_ON   HAL_GPIO_WritePin(GPIOC, GPIO_PIN_5, GPIO_PIN_SET)
# define DR_8_OFF  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_5, GPIO_PIN_RESET)
...
#define DRV_6_Pin GPIO_PIN_1
#define DRV_6_GPIO_Port GPIOC
#define DRV_7_Pin GPIO_PIN_2
#define DRV_7_GPIO_Port GPIOC
#define DRV_1_Pin GPIO_PIN_3
#define DRV_1_GPIO_Port GPIOC
#define SENS_1_Pin GPIO_PIN_0
#define SENS_1_GPIO_Port GPIOA
#define SENS_2_Pin GPIO_PIN_1
#define SENS_2_GPIO_Port GPIOA
#define SENS_3_Pin GPIO_PIN_2
#define SENS_3_GPIO_Port GPIOA
#define SENS_4_Pin GPIO_PIN_3
...
#define DRV_8_Pin GPIO_PIN_5
#define DRV_8_GPIO_Port GPIOC
#define CS_1_Pin GPIO_PIN_0
#define CS_1_GPIO_Port GPIOB
#define CS_2_Pin GPIO_PIN_1
#define CS_2_GPIO_Port GPIOB
#define DRV_5_Pin GPIO_PIN_2
#define DRV_5_GPIO_Port GPIOB
...
#define DRV_2_Pin GPIO_PIN_7
#define DRV_2_GPIO_Port GPIOC
#define DRV_3_Pin GPIO_PIN_8
#define DRV_3_GPIO_Port GPIOC
#define DRV_4_Pin GPIO_PIN_9
#define DRV_4_GPIO_Port GPIOC

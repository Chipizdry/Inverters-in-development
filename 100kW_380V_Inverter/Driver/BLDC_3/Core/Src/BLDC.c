...
void Phaze_A_PWM(void){HAL_TIM_PWM_Start(&htim1, TIM_CHANNEL_1);HAL_TIMEx_PWMN_Start(&htim1, TIM_CHANNEL_1);}
void Phaze_A_LOW(void){TIM1->CCR1 = 0;}// 0% duty → всегда LOW-side
...
void Phaze_B_PWM(void){HAL_TIM_PWM_Start(&htim1, TIM_CHANNEL_2);HAL_TIMEx_PWMN_Start(&htim1, TIM_CHANNEL_2);}
void Phaze_B_LOW(void){TIM1->CCR2 = 0;}// 0% duty → всегда LOW-side
...
void Phaze_C_PWM(void){HAL_TIM_PWM_Start(&htim1, TIM_CHANNEL_3);HAL_TIMEx_PWMN_Start(&htim1, TIM_CHANNEL_3);}
void Phaze_C_LOW(void){TIM1->CCR3 = 0;}// 0% duty → всегда LOW-side
